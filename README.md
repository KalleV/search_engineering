...
3. (Optional) Run docker by attaching volumes for the repo and the dataset: 
   3. Interactive: `docker run -v ~/forks/search_engineering:/workspace/search_engineering -v ~/forks/search_engineering/datasets:/workspace/datasets --network opensearch-net --name search_engineering -it gsingers/search_engineering:latest`
